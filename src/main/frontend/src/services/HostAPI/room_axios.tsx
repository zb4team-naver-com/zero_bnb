...
const getRoomInfo = async (hostId: number) => {
	const data = await axios.get(
		`http://ec2-3-16-183-72.us-east-2.compute.amazonaws.com/accommodation/search/${hostId}`
	)
	return data.data
}
...
export const putRoom = (accommodationId: number, data: any) => {
	return axios.put(
		`http://ec2-18-221-179-218.us-east-2.compute.amazonaws.com/accommodation/update/${accommodationId}`,
		data
	)
}
...
export const postRoom = (data: any) => {
	return axios.post(
		`http://ec2-3-16-183-72.us-east-2.compute.amazonaws.com/accommodation/register`,
		data
	)
}
