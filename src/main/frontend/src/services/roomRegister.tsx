...
export const roomInitValues: Room[] = [
	{
		...
		accommodationImageInputs: [
			{
				url: "https://zerobnb-bucket.s3.amazonaws.com/image/%ED%98%B8%ED%85%94%EC%82%AC%EC%A7%848.png",
			},
		],
	},

	{
		...
		name: "정목호텔",
		notice:
			"다들 안녕하세요. 정목호텔입니다. 과도한 음주는 삼가해주시길 바랍니다.",
		policy: "제1조: 호텔을 꺠끗이 쓰도록 한다.",
		eventInputs: [],
		popularFacilityServiceInputs: [{ popularFacilityServiceType: 1 }],
		accommodationImageInputs: [
			{
				url: "https://zerobnb-bucket.s3.amazonaws.com/image/%ED%98%B8%ED%85%94%EC%82%AC%EC%A7%841.png",
			},
		],
	},

	{
		...
		accommodationImageInputs: [
			{
				url: "https://zerobnb-bucket.s3.amazonaws.com/image/%ED%98%B8%ED%85%94%EC%82%AC%EC%A7%845.jpg",
			},
		],
	},
]
