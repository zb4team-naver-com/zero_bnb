...
INSERT INTO accommodation
values (3, NOW(), NOW(), 'MOTEL', '서울 신림구 신림동 신림짝모텔', '둘이 들어가서 셋이되서 나오는 짝 모텔', false, 25.5, 34.4, '신림짝모텔',
        '신림짝 모텔입니다. 즐거운 사랑을 나누세요.',
        '쓰고간 곳은 청결히 유지해주세요. 위반 시 벌금 1백만원', 25, 2);
INSERT INTO accommodation
values (4, NOW(), NOW(), 'MOTEL', '서울 강남구 강남동 강남 어게인', '밝게 빛나는 강남 어게인', false, 25.5, 34.4, '강남어게인', '강남 어게인 입니다.',
        '1. 뒷처리는 깔끔히 한다. 2. 쓰고남은 휴지는 휴지통에 버린다.', 509, 3);
INSERT INTO accommodation
values (5, NOW(), NOW(), 'GUEST_HOUSE', '제주 특별시 감귤 게스트 하우스', '어서오세요, 감귤 게스트 하우스 입니다.', false, 25.5, 34.4, '감귤 게스트 하우스',
        '편하게 즐기다 가세요~',
        '놀다간 뒷처리는 깔끔하게~', 119, 4);
INSERT INTO accommodation
values (6, NOW(), NOW(), 'VILLA', '경남 김해시 진주빌라', '진주 빌라 입니다.', false, 25.5, 34.4, '진주빌라', '어서오세요~ 진주빌라입니다.',
