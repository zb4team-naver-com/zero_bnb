...
values (1, NOW(), NOW(), '010-5948-3938', '2013161993',
        'https://zerobnb-bucket.s3.amazonaws.com/image/%EA%B9%80%EA%B0%91%EC%88%98.png', 'ACTIVE', 1);

INSERT INTO host
values (2, NOW(), NOW(), '010-4343-5435', '5958474733',
        'https://zerobnb-bucket.s3.amazonaws.com/image/%EA%B9%80%EA%B0%91%EB%A3%A1.png', 'ACTIVE', 2);

INSERT INTO host
values (3, NOW(), NOW(), '010-9433-3544', '1952434533',
        'https://zerobnb-bucket.s3.amazonaws.com/image/%EC%95%88%EC%88%99%ED%9D%AC.jpg', 'ACTIVE', 4);

INSERT INTO host
values (4, NOW(), NOW(), '010-2955-4948', '3837273644',
        'https://zerobnb-bucket.s3.amazonaws.com/image/%EC%95%84%EC%9D%B4%EC%9C%A0.jpg', 'ACTIVE', 9);

INSERT INTO host
values (5, NOW(), NOW(), '010-3948-4938', '5453442233',
        'https://zerobnb-bucket.s3.amazonaws.com/image/%EA%B9%80%EC%A0%95%EC%9D%80.jpg', 'ACTIVE', 10);
...
values (1, NOW(), NOW(), 'PENSION', '충북 청주시 노원구 삼할동 떙떙번지', '호텔 뷰가 정말 좋은 장소입니다.', false, 25.5, 34.4, '정목호텔',
        '다들 안녕하세요. 정목호텔입니다. 과도한 음주는 삼가해주시길 바랍니다.', '제1조: 호텔을 꺠끗이 쓰도록 한다.', 125, 1);
INSERT INTO accommodation
values (2, NOW(), NOW(), 'PENSION', '서울 강서구 등촌동 구구호텔', '강서구 최고의 경치!!', false, 25.5, 34.4, '구구호텔',
        '구구호텔에 오신 것을 환영합니다. 과도한 애정행각은 금지입니다.',
        '쓰고간 곳은 청결히 유지해주세요.', 11, 2);
INSERT INTO accommodation
values (3, NOW(), NOW(), 'MOTEL', '서울 신림구 신림동 신림짝모텔', '둘이 들어가서 셋이되서 나오는 짝 모텔', false, 23.5, 34.4, '신림짝모텔',
        '신림짝 모텔입니다. 즐거운 사랑을 나누세요.',
        '쓰고간 곳은 청결히 유지해주세요. 위반 시 벌금 1백만원', 25, 2);
INSERT INTO accommodation
values (4, NOW(), NOW(), 'MOTEL', '서울 강남구 강남동 강남 어게인', '밝게 빛나는 강남 어게인', false, 25.5, 31.4, '강남어게인', '강남 어게인 입니다.',
        '1. 뒷처리는 깔끔히 한다. 2. 쓰고남은 휴지는 휴지통에 버린다.', 509, 3);
INSERT INTO accommodation
values (5, NOW(), NOW(), 'GUEST_HOUSE', '제주 특별시 감귤 게스트 하우스', '어서오세요, 감귤 게스트 하우스 입니다.', false, 27.5, 35.4, '감귤 게스트 하우스',
        '편하게 즐기다 가세요~',
        '놀다간 뒷처리는 깔끔하게~', 119, 4);
INSERT INTO accommodation
values (6, NOW(), NOW(), 'VILLA', '경남 김해시 진주빌라', '진주 빌라 입니다.', false, 26.5, 33.4, '진주빌라', '어서오세요~ 진주빌라입니다.',
...
-- 1번 호텔 방 정의
INSERT INTO ROOM
values (1, now(), now(), '침실2대 풀사이즈 제공', 18000, '평온하고 쓰기 좋은 방이에요.', 40, false, 2, '라벤더룸', 20, false, 2, 1);

INSERT INTO ROOM
values (2, now(), now(), '넓은 사이즈의 침대, 향수 풀옵션 제공', 200000, '한번 들어오면 나가기 싫어지는 방', 20, false, 2, '풀옵션방', 25, false, 2, 1);

INSERT INTO ROOM
values (3, now(), now(), '침실2대 풀사이즈 제공', 30000, '평온하고 쓰기 좋은 방이에요.', 15, false, 2, '글래스룸', 20, false, 2, 1);

-- 2번 호텔 방 정의
INSERT INTO ROOM
values (4, now(), now(), '침실2대 풀사이즈 2대 제공, 장미향 옵션', 20000, '은은한 장미향이 코끝을 맴도는 매혹적인 방', 50, false, 2, '로즈룸', 10, false, 2,
        2);

INSERT INTO ROOM
values (5, now(), now(), '에이스 침대, 해바라기향 옵션', 25000, '해바라기 향이 맴도는 머물다 가기 좋은 방이에요', 35, false, 2, '해바라기방', 20, false, 2,
        2);


-- 3번 호텔 방 정의
INSERT INTO ROOM
values (6, now(), now(), '풀옵션 구비', 50000, '스탠다드 방입니다. 문의사항이 있으면 안내데스크로 연락 주세요.', 10, false, 2, '스탠다드룸', 18, false, 2,
        3);

INSERT INTO ROOM
values (7, now(), now(), '풀옵션 구비', 300000, '라지 룸입니다. 문의사항이 있으면 안내데스크로 연락 주세요.', 15, false, 2, '라지룸', 20, false, 2, 3);


-- 4번 호텔 방 정의
INSERT INTO ROOM
values (8, now(), now(), '초강력특가-14시 체크아웃', 30000, '상세 설명의 취소규정에 따라 취소가 가능하며, 취소를 원하시는 경우 고객센터로 연락 부탁 드립니다.', 0, false,
        2,
        '스탠다드룸', 28, false,
        2, 4);
...
체크인 기준 3일전 17시까지 100% 환불', 500000, '상세 설명의 취소규정에 따라 취소가 가능하며, 취소를 원하시는 경우 고객센터로 연락 부탁 드립니다.
...
★모든 추가비용 현장결제', 20, false, 2, '파노라믹 스위트', 30, false, 2, 4);
...
https://blog.naver.com/otmtech/221225799944', 300000, '온수는 31도, 온수요금은 별도로 받지 않고 객실요금에 포함입니다.
...
다른 이용객에게 피해를 줄 수 있는 무분별한 오락, 음주, 고성방가는 삼가주시기 바랍니다.', 25, false, 6, '달의연인', 25, false, 4, 5);
...
야외개별데크에서 숯불로 이용하실 경우 2~4인 20,000원 / 4인초과시 30,000원입니다.
입실 후 현장에서 결제부탁드립니다.
* 여우의정원에 대해 더 상세한 내용을 확인해보세요', 30000, '온수는 31도, 온수요금은 별도로 받지 않고 객실요금에 포함입니다.
예약 인원에서 인원이 추가되는 경우 펜션에 미리 연락을 주시기 바랍니다.
최대 인원 초과 시 입실이 불가능할 수 있으며, 해당 사유로 환불 받을 수 없습니다.
반려동물 동반시 입실이 거부되며, 해당 사유로 환불 받을수 없습니다.
미성년자는 숙박이 불가능합니다.
...
객실의 안전과 화재예방을 위해 객실 내에서 생선이나 고기 등을 굽는 직화 방식은 허용되지 않으며, 개인적으로 준비해 오는 취사도구(그릴, 숯, 전기/전열기구 등)은 반입이 금지되어 있습니다.
객실 내에서의 흡연은 금지되어 있으며, 지정된 장소를 이용해 주시기 바랍니다.
다른 이용객에게 피해를 줄 수 있는 무분별한 오락, 음주, 고성방가는 삼가주시기 바랍니다.', 15, false, 4, '여우의정원', 10, false, 2, 5);
...
ㄴ인원 초과시 1인당 15,000원 현장지불 해야합니다.', 50000, '당일예약은 특성상 환불 및 취소가 불가합니다.
...
제휴점 사정으로 객실 정보가 수시로 변경될 수 있습니다. 이로 인한 불이익은 당사가 책임지지 않습니다.', 20, false, 6, '테라스 복층 룸', 15, false, 2, 6);
...
인원수에 맞지 않는 결제가 이루어질시 투숙이 불가한 점 양해부탁드리겠습니다.', 25000, '당일예약은 특성상 환불 및 취소가 불가합니다.
체크인은 23:00까지 가능합니다. 23:00 이후 입실이 불가하며 이 경우, 취소/환불은 불가합니다.
객실요금은 기준인원에 따라 다르며, 파티룸 등 특수객실의 경우, 직접 입실 인원 확인이 필요합니다.
도미토리객실은 타인과 함께 이용하는 다인실입니다. 결제시, 1인 1개 베드가 예약됩니다.
미성년자의 입실 가능여부는 직접 제휴점에 확인 후 예약 진행하시기 바랍니다.
미성년자 혼숙예약으로 인해 발생하는 입실 거부에 대해서는 취소/환불이 불가합니다.
제휴점 사정에 의한 취소 발생 시 100% 환불 처리됩니다.
제휴점 사정으로 객실 정보가 수시로 변경될 수 있습니다. 이로 인한 불이익은 당사가 책임지지 않습니다.', 20, false, 6, '남성 도미토리 6-7인실', 15, false, 1, 6);
 ...
 */
INSERT INTO COUPON
values (1, now(), now(), 10, 30, '선착순 30% 대실 할인 쿠폰!', 1);
INSERT INTO COUPON
values (2, now(), now(), 10, 10, '선착순 10% 숙박 할인 쿠폰!', 1);

INSERT INTO COUPON
values (3, now(), now(), 30, 50, '선착순 50% 숙박/대실 할인 쿠폰!', 3);

INSERT INTO COUPON
values (4, now(), now(), 50, 25, '25% 대실 할인 쿠폰입니다.', 4);
INSERT INTO COUPON
values (5, now(), now(), 50, 45, '45% 숙박 할인 쿠폰 입니다.', 4);


INSERT INTO COUPON
values (6, now(), now(), 30, 20, '20% 대실 할인 쿠폰', 5);
INSERT INTO COUPON
values (7, now(), now(), 30, 20, '20% 숙박 할인 쿠폰', 5);
INSERT INTO COUPON
values (8, now(), now(), 30, 20, '20% 숙박/대실 할인 쿠폰', 5);
