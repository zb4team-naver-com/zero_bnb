...
-- 1번 호텔 방 정의
INSERT INTO ROOM
values (1, now(), now(), '침실2대 풀사이즈 제공', 18000, '평온하고 쓰기 좋은 방이에요.', 40, 2, '라벤더룸', 20, false, 2, 1);

INSERT INTO ROOM
values (2, now(), now(), '넓은 사이즈의 침대, 향수 풀옵션 제공', 200000, '한번 들어오면 나가기 싫어지는 방', 20, 2, '풀옵션방', 25, false, 2, 1);

INSERT INTO ROOM
values (3, now(), now(), '침실2대 풀사이즈 제공', 30000, '평온하고 쓰기 좋은 방이에요.', 15, 2, '글래스룸', 20, false, 2, 1);

-- 2번 호텔 방 정의
INSERT INTO ROOM
values (4, now(), now(), '침실2대 풀사이즈 2대 제공, 장미향 옵션', 20000, '은은한 장미향이 코끝을 맴도는 매혹적인 방', 50, 2, '로즈룸', 10, false, 2, 2);

INSERT INTO ROOM
values (5, now(), now(), '에이스 침대, 해바라기향 옵션', 25000, '해바라기 향이 맴도는 머물다 가기 좋은 방이에요', 35, 2, '해바라기방', 20, false, 2, 2);


-- 3번 호텔 방 정의
INSERT INTO ROOM
values (6, now(), now(), '풀옵션 구비', 50000, '스탠다드 방입니다. 문의사항이 있으면 안내데스크로 연락 주세요.', 10, 2, '스탠다드룸', 18, false, 2, 3);

INSERT INTO ROOM
values (7, now(), now(), '풀옵션 구비', 300000, '라지 룸입니다. 문의사항이 있으면 안내데스크로 연락 주세요.', 15, 2, '라지룸', 20, false, 2, 3);


-- 4번 호텔 방 정의
INSERT INTO ROOM
values (8, now(), now(), '초강력특가-14시 체크아웃', 30000, '상세 설명의 취소규정에 따라 취소가 가능하며, 취소를 원하시는 경우 고객센터로 연락 부탁 드립니다.', 0, 2,
        '스탠다드룸', 28, false,
        2, 4);
...
★모든 추가비용 현장결제', 20, 2, '파노라믹 스위트', 30, false, 2, 4);
...
다른 이용객에게 피해를 줄 수 있는 무분별한 오락, 음주, 고성방가는 삼가주시기 바랍니다.', 25, 6, '달의연인', 25, false, 4, 5);
...
객실의 안전과 화재예방을 위해 객실 내에서 생선이나 고기 등을 굽는 직화 방식은 허용되지 않으며, 개인적으로 준비해 오는 취사도구(그릴, 숯, 전기/전열기구 등)은 반입이 금지되어 있습니다.
객실 내에서의 흡연은 금지되어 있으며, 지정된 장소를 이용해 주시기 바랍니다.
다른 이용객에게 피해를 줄 수 있는 무분별한 오락, 음주, 고성방가는 삼가주시기 바랍니다.', 15, 4, '여우의정원', 10, false, 2, 5);
...
제휴점 사정으로 객실 정보가 수시로 변경될 수 있습니다. 이로 인한 불이익은 당사가 책임지지 않습니다.', 20, 6, '테라스 복층 룸', 15, false, 2, 6);
...
미성년자 혼숙예약으로 인해 발생하는 입실 거부에 대해서는 취소/환불이 불가합니다.
제휴점 사정에 의한 취소 발생 시 100% 환불 처리됩니다.
제휴점 사정으로 객실 정보가 수시로 변경될 수 있습니다. 이로 인한 불이익은 당사가 책임지지 않습니다.', 20, 6, '남성 도미토리 6-7인실', 15, false, 1, 6);
